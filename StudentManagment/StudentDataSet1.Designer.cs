...
namespace StudentManagment.StudentDataSet1TableAdapters {
    ...
    public partial class TeacherTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Teacher] WHERE (([TID] = @Original_TID) AND ([TeacherName] = @" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Teacher] SET [TeacherName] = @TeacherName WHERE (([TID] = @Original" +
                "_TID) AND ([TeacherName] = @Original_TeacherName));\r\nSELECT TID, TeacherName FRO" +
                "M Teacher WHERE (TID = @TID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TID, TeacherName FROM dbo.Teacher";
        ...
        public virtual int Fill(StudentDataSet1.TeacherDataTable dataTable) {
        ...
        public virtual StudentDataSet1.TeacherDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentDataSet1.TeacherDataTable dataTable = new StudentDataSet1.TeacherDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentDataSet1.TeacherDataTable dataTable) {
        ...
        public virtual int Delete(int Original_TID, string Original_TeacherName) {
        ...
        public virtual int Update(string TeacherName, int Original_TID, string Original_TeacherName, int TID) {
            if ((TeacherName == null)) {
            ...
            if ((Original_TeacherName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_TeacherName));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TeacherName, int Original_TID, string Original_TeacherName) {
            return this.Update(TeacherName, Original_TID, Original_TeacherName, Original_TID);
        }
    }
