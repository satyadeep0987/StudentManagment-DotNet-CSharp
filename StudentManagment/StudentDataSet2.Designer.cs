...
namespace StudentManagment {
    ...
    public partial class StudentDataSet2 : global::System.Data.DataSet {
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CourseRow AddCourseRow(string CourseName, decimal fees) {
        ...
        public partial class CourseRow : global::System.Data.DataRow {
            ...
            public decimal fees {
                get {
                    return ((decimal)(this[this.tableCourse.feesColumn]));
                }
                set {
                    this[this.tableCourse.feesColumn] = value;
                }
            }
        }
...
namespace StudentManagment.StudentDataSet2TableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Course] WHERE (([CID] = @Original_CID) AND ([CourseName] = @Or" +
                "iginal_CourseName) AND ([fees] = @Original_fees))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Course] SET [CourseName] = @CourseName, [fees] = @fees WHERE (([CID" +
                "] = @Original_CID) AND ([CourseName] = @Original_CourseName) AND ([fees] = @Orig" +
                "inal_fees));\r\nSELECT CID, CourseName, fees FROM Course WHERE (CID = @CID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentManagment.Properties.Settings.Default.StudentConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CID, CourseName, fees FROM dbo.Course";
        ...
        public virtual int Fill(StudentDataSet2.CourseDataTable dataTable) {
        ...
        public virtual StudentDataSet2.CourseDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentDataSet2.CourseDataTable dataTable = new StudentDataSet2.CourseDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentDataSet2.CourseDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CID, string Original_CourseName, decimal Original_fees) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((decimal)(Original_fees));
        ...
        public virtual int Update(string CourseName, decimal fees, int Original_CID, string Original_CourseName, decimal Original_fees, int CID) {
            if ((CourseName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((decimal)(fees));
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(Original_fees));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CourseName, decimal fees, int Original_CID, string Original_CourseName, decimal Original_fees) {
            return this.Update(CourseName, fees, Original_CID, Original_CourseName, Original_fees, Original_CID);
        }
    }
